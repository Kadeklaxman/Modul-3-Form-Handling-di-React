...
function CreatePostForm() {
  ...
  const fieldClass = (fieldName: keyof PostFormData): string =>
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <select {...register("category")} className={fieldClass("category")}>
      ...
      <div>
        ...
        <div className="flex gap-4 flex-wrap">
          <label className="flex items-center gap-2">
            <input type="checkbox" value="React" {...register("tags")} />
            React
          </label>

          <label className="flex items-center gap-2">
            <input type="checkbox" value="TypeScript" {...register("tags")} />
            TypeScript
          </label>

          <label className="flex items-center gap-2">
            <input type="checkbox" value="Zod" {...register("tags")} />
            Zod
          </label>
        </div>
